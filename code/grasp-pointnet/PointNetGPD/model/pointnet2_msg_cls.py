...
from model.pointnet2_modules import PointnetSAModuleMSG, PointnetSAModule
...
class Pointnet2MSG(nn.Module):
    ...
    def forward(self, pointcloud):
        ...
        x = self.dp1(F.relu(self.bn1(self.fc1(features.squeeae(-1)))))
        x = self.dp1(F.relu(self.bn2(self.fc2(x))))
        x = self.fc3(x)
