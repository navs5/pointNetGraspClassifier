...
class base_model(object):
    ...
    def fit(self, train_data, train_cat, train_labels, val_data, val_cat, val_labels, is_continue=True):
        f = open("train.log", "a")
        #t_process, t_wall = time.process_time(), time.time()--I took this out
    ...
    def training(self, loss, learning_rate, decay_steps, decay_rate=0.95, momentum=0.8): #was 0.95 and 0.8
        """Adds to the loss model the Ops required to generate and apply gradients."""
        learning_rate=0.03#<--I added this
